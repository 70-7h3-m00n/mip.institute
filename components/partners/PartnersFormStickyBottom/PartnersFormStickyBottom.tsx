...
import stls from './PartnersFormStickyBottom.module.sass'
...
const PartnersFormStickyBottom = ({
  ...
  const { program, seminar, bachelor, updateTicketsQuantity } = useContext(ContextStaticProps)
  ...
  return (
    <>
      ...
      <div className={stls.container}>
        ...
        <h3 className={stls.title}>{cta}</h3>
            ...
            <div className={stls.group}>
              ...
              {agreement && (
                <p className={stls.agreement}>
                  Нажимая кнопки на сайте Вы даете свое согласие на обработку Ваших персональных
                  данных
                </p>
              )}
              {isIpCheckFailed && (
...
export default PartnersFormStickyBottom
