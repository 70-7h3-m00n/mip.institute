    ...
    <div className={stls.container}>
      <div className={stls.top}>
        ...
        <p className={stls.description}>
          <span className={stls.color}>Студенты доверяют нашим кураторам</span> — увлеченным специалистам с психологическим образованием, ведущими частную практику, которые всегда готовы поддержать и прийти на помощь
        </p>
      </div>
