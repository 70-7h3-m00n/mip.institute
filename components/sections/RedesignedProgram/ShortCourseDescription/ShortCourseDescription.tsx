...
const modulesInfo = [
  {
    ...
    modules: [
      ...
      {
        moduleName: 'Основы патопсихологии (с практикумом)', //"хз что тут"
        studyHours: 28,
        description:
  ...
  },
  {
    ...
    modules: [
      ...
      {
        moduleName: 'Психологическое консультирование', //"хз что тут"
        studyHours: 72 + 36,
        description:
